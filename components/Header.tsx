  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-6 py-6 flex justify-between items-center bg-black/40 backdrop-blur-3xl border-b border-white/5">
      <div className="flex items-center">
        {/* 
          One UI 8 Inspired Logo Design:
          Line 1: AI STUDIO (Blue #3E7BFA) - Small, widely tracked.
          Line 2: IVISION (White) - Bold and modern.
        */}
        <div className="flex flex-col items-start leading-none gap-1">
          <span className="text-[10px] font-black tracking-[0.3em] text-[#3E7BFA] uppercase w-full text-left whitespace-nowrap">
            AI STUDIO
          </span>
          <span className="text-3xl md:text-4xl font-black tracking-[-0.04em] text-white uppercase leading-[0.8] whitespace-nowrap">
            IVISION
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        {/* Behance - Updated to simple "Be" text */}
        <a 
