  ...
  return (
    <section className="relative pt-44 pb-20 px-6 flex flex-col items-center text-center max-w-6xl mx-auto overflow-hidden">
      ...
      <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <h1 className="text-6xl md:text-[5.5rem] font-black tracking-tighter mb-6 bg-gradient-to-b from-white via-white to-white/30 bg-clip-text text-transparent leading-[1.05]">
          Ivision AI Studio
        </h1>
        
        <p className="text-xl md:text-2xl text-white/50 mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
          A free and simple website for creating and editing images with AI
        </p>
      ...
      <div className="w-full glass-panel squircle p-3 shadow-[0_50px_120px_rgba(0,0,0,0.9)] border border-white/10 relative overflow-hidden group animate-in zoom-in-95 duration-1000 delay-300">
        <div className="aspect-video w-full rounded-[40px] overflow-hidden bg-[#0A0A0A] flex border border-white/5 shadow-inner">
          ...
          {/* Sidebar Left */}
          <div className="w-[30%] border-r border-white/5 bg-[#0D0D0D] p-6 flex flex-col gap-6 text-left pointer-events-none">
            ...
            <div className="space-y-3 flex-1">
              <div className="flex justify-between items-center">
                ...
                <div className="px-2 py-1 bg-blue-500/10 rounded-md flex items-center gap-1">
                   ...
                   <span className="text-[8px] font-bold text-blue-400">Smart</span>
                </div>
              </div>
              <div className="w-full h-32 bg-white/[0.03] rounded-2xl border border-white/5 p-4">
                <span className="text-xs text-white/20">Describe your vision...</span>
              </div>
            </div>
          </div>

          {/* Main Area Right */}
          <div className="flex-1 p-8 flex flex-col gap-6 text-left pointer-events-none overflow-hidden">
            <div className="flex justify-between items-start">
              <div>
                <span className="text-[10px] font-black text-[#3E7BFA] tracking-[0.3em] uppercase">Creative Studio</span>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <h4 className="text-xl font-bold text-white">Recent</h4>
              ...
              <div className="w-full bg-[#1A1A1A] rounded-2xl p-4 border border-white/5 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[9px] text-white/30 mt-1">14:22 • 1 VARIANTS</p>
                </div>
                <div className="flex gap-2">
                  <div className="w-7 h-7 rounded-lg bg-white/5 border border-white/5"></div>
                  <div className="w-7 h-7 rounded-lg bg-white/5 border border-white/5"></div>
                </div>
              </div>
            </div>
